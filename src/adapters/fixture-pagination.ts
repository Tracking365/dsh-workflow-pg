...
export function assertPaginationFixturePolicy(policy: HostPolicy): void {
  ...
  if (policy.recoveryControlPlane !== undefined || !repository || repository.contextPaths !== undefined || !sameList(repository.allowedPaths, ["src/"]) || !sameList(repository.protectedPaths, ["test/"])) throw new DevkitError("FIXTURE_REPOSITORY_POLICY_INVALID");
